    ...
    <style>
        ...
        .card .listview > li:last-child .item {
         ...
         <div class="section home">
            <div class="top-left text-muted text-light" style="font-size: 11px;">
              <?= $_CONFIG['title'] ?> Cash
            </div>
            <div class="top-balance text-muted text-light font-size: 13px;">
                Rp<font style="font-size: 20px:"><b><?= currency($data_user['balance']) ?></b></font>
            </div>
            <div class="top-coin text-muted text-light" style="font-size: 12px;">
                Poin <font style="color: #FFB000; font-size: 12px;"><?= currency($data_user['point']) ?></font>
            </div>
            ...
            <div class="menu-list mt-1" style="border-top: 0 !important;">
                <div class="app-menu">
                    <a href="<?= base_url('order/pulsa-reguler') ?>" class="item">
                        ...
                        <span class="btn btn-danger btn-status rounde">Promo</span>
                            <img src="<?= assets('mobile/icon/png/pulsa-reg.png') ?>" width="63px" height="63px">
                            <strong style="color: #666666;">Pulsa Reguler</strong>
                        </div>
                    </a>
                  <!--
                    ...
                    <a href="<?= base_url('order/paket-internet') ?>" class="item">
                        <div class="col"> 
                            <span class="btn btn-danger btn-status rounde">Promo</span>
                            <img src="<?= assets('mobile/icon/png/data.png') ?>" width="63px" height="63px">
                    ...
                    <a href="<?= base_url('order/games') ?>" class="item">
                        <div class="col">
                            <img src="<?= assets('mobile/icon/png/voucher-game.png') ?>" width="63px" height="63px">
                            <font style="color: #888888;">Games</font>
                        </div>
                    </a>
                </div>
                <div class="app-menu mt-4 mb-2">
                    ...
                    <a href="/donasi" class="item">
                        <div class="col">
                            <img src="<?= assets('mobile/icon/png/donasi.png') ?>" width="60px" height="60px">
