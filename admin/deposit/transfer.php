                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title" title="Click to Add"><i class="fas fa-history mr-2"></i> Transfer History </h4>
                           </div>
                        </div>
...
if(isset($_GET['show'])) {
    ...
    $search = "SELECT * FROM deposit WHERE method = 'transfer' AND user LIKE '%$pt_search%' OR sender LIKE '%$pt_search%' ORDER BY id DESC";
} else {
...
?>
                                        <tr>
                                            ...
                                            <td><span class="badge badge-primary"><?= $call->query("SELECT name FROM users WHERE username = '".$row_query['sender']."'")->fetch_assoc()['name'] ?></span></td>
                                            ...
                                            <td><span class="badge badge-warning"><?= 'Rp '.currency($row_query['amount']) ?></span></td>
                                        </tr>
<? $i++; } ?>
                                </tbody>
                              </table>
