                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title"><i class="fas fa-history mr-2"></i> Log Mutasi Member </h4>
                           </div>
                        </div>
...
if(isset($_GET['show'])) {
    ...
    $search = "SELECT * FROM mutation WHERE type LIKE '%$pt_search%' AND kategori IN ('Transaksi', 'Deposit', 'Lainnya', 'Tarik Komisi') ORDER BY id DESC";
} else {
    $search = "SELECT * FROM mutation WHERE kategori IN ('Transaksi', 'Deposit', 'Lainnya', 'Tarik Komisi') ORDER BY id DESC";
}
