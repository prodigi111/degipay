                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title" title="Click to Add" onclick="modal('New Data','<?= base_url('admin/service/add') ?>','','lg')"><i class="fas fa-plus-circle mr-2"></i> Service </h4>
                           </div>
                        </div>
...
?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="javascript:;" onclick="modal('Detail Service','<?= base_url('admin/service/detail?q='.base64_encode($row_query['id'])) ?>','','md')" class="btn btn-sm btn-primary">
                                                <i class="fas fa-list" title="Detail Service"></i>
                                            </a>
                                            <a href="javascript:;" onclick="modal('Edit Service','<?= base_url('admin/service/edit?q='.base64_encode($row_query['id'])) ?>','','md')" class="btn btn-sm btn-warning text-white">
