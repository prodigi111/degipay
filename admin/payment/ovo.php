                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title"><i class="fas fa-credit-card mr-2"></i> List of OVO Balance Movements </h4>
                           </div>
                        </div>
...
if(isset($_GET['show'])) {
    ...
    $search = "SELECT * FROM deposit_bank WHERE amount LIKE '%$pt_search%' AND bank = 'OVO' ORDER BY id DESC";
} else {
    $search = "SELECT * FROM deposit_bank WHERE bank = 'OVO' ORDER BY id DESC";
}
