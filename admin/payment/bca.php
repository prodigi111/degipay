                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title"><i class="fas fa-credit-card mr-2"></i> List of BCA Balance Movements </h4>
                           </div>
                        </div>
...
if(isset($_GET['show'])) {
    ...
    $search = "SELECT * FROM deposit_bank WHERE amount LIKE '%$pt_search%' AND bank = 'BCA' ORDER BY id DESC";
} else {
    $search = "SELECT * FROM deposit_bank WHERE bank = 'BCA' ORDER BY id DESC";
}
...
?>
                                        <tr>
                                            ...
                                            <td><?= format_date('en',substr($row_query['date'],0,10)) ?></td>
                                            <td><span class="badge badge-primary"><?= $row_query['account'] ?></span></td>
                                            <td><span class="badge badge-success"><?= $row_query['amount'] ?></span></td>
                                            <td><?= $row_query['description'] ?></td>
                                            <td><span class="badge badge-warning"><?= $row_query['sender'] ?></span></td4
                                        </tr>
<? } ?>
                                </tbody>
                              </table>
