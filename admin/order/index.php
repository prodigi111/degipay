...
if(isset($_GET['show'])) {
    ...
    $search = "SELECT * FROM trx WHERE trxtype IN ('prepaid','postpaid','shop') AND status LIKE '%$pt_search%' AND wid LIKE '%$pt_search2%' ORDER BY id DESC";
} else {
    $search = "SELECT * FROM trx WHERE trxtype IN ('prepaid','postpaid','shop') ORDER BY id DESC";
}
                                        ...
                                        <tr>
                                            <form method="POST" class="form-inline" role="form">
                                                ...
                                                <td align="center" style="min-width:120px;">
                                                    <button title="Detail Data" type="button" onclick="modal('Order Details','<?= base_url('order/rincian?code='.$row_query['wid']) ?>','','md')" class="btn btn-sm btn-info">
                                                        <i class="fas fa-receipt"></i>
                                                    </button>
                                                    <button title="Edit Data" type="submit" name="edit" class="btn btn-sm btn-primary">
                                                        <i class="fas fa-pencil-alt"></i>
                                                    </button>
                                                    <button title="Print Transaction" type="button" onclick="printSingleTransaction(this)" class="btn btn-sm btn-secondary">
...
?>                                    
                   ...
                   <script>
function printSingleTransaction(button) {
    // Get the row
    ...
    const data = cells[4].querySelector('input').value;
    const note = cells[5].querySelector('textarea').value;
        ...
        <body>
            <div class="header">
                <div class="logo-container">
                     <img src="https://degipay.id/library/assets/images/degipay.png" alt="Company Logo" class="logo">
                </div>
                <div class="company-name"><?= $_CONFIG['title'] ?></div>
