...
require 'action.php';
$page = isset($_SESSION['success']) ? 'Pembayaran Berhasil' : 'Masa Aktif';
                            ...
                            <div class="in">
                                <div class="form-group basic">
                                    <div class="input-wrapper">
                                        ...
                                        <input type="number" class="form-control" placeholder="Masukkan Nomor Tujuan" name="data" id="data" required>
                                        <i class="input">
