                    ...
                    <input type="hidden" id="csrf_token" name="csrf_token" value="<?= $csrf_string ?>">
                        <div class="form-bottom-fixed">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn rounded btn-primary btn-block btn-lg m-1 mb-0" name="buymanual" onclick="var e=this;setTimeout(function(){e.disabled=true;},0);return true;">Konfirmasi</button>
                            </div>
                        </div>
                    </form>
                </div>
