...
$search_cat = $call->query("SELECT * FROM category WHERE name = '$get_s' AND type IN ('voucher', 'voucher-data','tv')");
if($search_cat->num_rows == 0) exit(redirect(0,base_url('order/voucher')));
