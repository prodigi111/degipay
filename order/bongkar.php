        ...
        <form method="POST">
            ...
            <div class="wide-block pb-1 pt-1 mt-1">
                ...
                <ul class="listview image-listview no-line no-space flush">
                    <li>
                        <div class="item">
                            <img src="<?= assets('mobile/img/home/bongkar.jpg') ?>" width="36px" class="image" id="RGSLogo">
                            <div class="in">
                    ...
                    <div class="item">
                        <div class="in">
                            <div class="form-group basic">
                                <div class="input-wrapper">
                                    <label class="label"> Jumlah Bongkar</label>
                                    <input type="number" class="form-control" name="bongkar" placeholder="contoh 10b" required>
                                </div>
                            </div>
                        </div>
                    </div>
