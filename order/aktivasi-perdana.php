...
require 'action.php';
$page = isset($_SESSION['success']) ? 'Pembayaran Berhasil' : 'Aktivasi Perdana';
...
">
            <div class="wide-block-service">
                ...
                <ul class="listview image-listview no-line no-space flush">
                    <li>
                        <div class="item">
                            <img src="<?= assets('images/icon/inject-voucher.png').'?'.time() ?>" width="50px" height="50px" class="image" id="RGSLogo">
                            <div class="in">
                                <div class="form-group basic">
                                    <div class="input-wrapper">
                                        <label class="label">Nomor HP</label>
                                        <input type="number" class="form-control" placeholder="Masukkan Nomor HP" name="data" id="data">
                                        <i class="clear-input">
...
$(document).ready(function() {
    $("#data").keyup(function() {
        ...
        $.ajax({
            type: 'POST',
            data: 'phone=' + target + '&type=aktivasi-perdana&csrf_token=<?= $csrf_string ?>',
        ...
        $.ajax({
            type: 'POST',
            data: 'data=' + target + '&type=aktivasi-perdana&csrf_token=<?= $csrf_string ?>',
